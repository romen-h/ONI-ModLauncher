...
namespace ONIModLauncher.Core
{
	public class ONIMod : INotifyPropertyChanged
	{
		...
		public PresetColor BackgroundColor
		{
			get
			{
				if (IsBroken)
				...
				return Type switch
				{
					ModType.Local => PresetColor.Yellow,
					ModType.Steam => PresetColor.Blue,
					ModType.Dev => PresetColor.Orange,
					_ => PresetColor.Gray,
				};
			}
		}
		...
		public bool IsBroken
		{
			...
			set
			{
				...
				InvokePropertyChanged(nameof(BackgroundColor));
			}
		}
		...
		public void OpenConfig() => ShellHelper.OpenTextFile(ConfigFile);
		
		public bool CanOpenWorkshop => IsSteam;
		public void OpenWorkshop() => ShellHelper.OpenURL($"https://steamcommunity.com/sharedfiles/filedetails/?id={SteamWorkshopId}");

		public bool CanOpenRepo => RepoUrl != null;
		public void OpenRepo() => ShellHelper.OpenURL(RepoUrl);

		public bool CanOpenFolder => true;
		public void OpenFolder() => ShellHelper.OpenFolder(Folder);
